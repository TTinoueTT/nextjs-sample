            ...
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="mt-8 space-y-6">
                    <div className="text-center">
                        <button className="flex w-full items-center justify-center rounded bg-gray-900 px-4 py-2 font-bold text-white hover:bg-gray-700">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="mr-2 h-6 w-6" fill="currentColor">
